...
public class StarShowActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.tab_topShow){
            ShadowLayout.setShadowHiddenTop(select(tab_topShow));
        }
        if(v.getId()==R.id.tab_bottomShow){
            ShadowLayout.setShadowHiddenTop(select(tab_bottomShow));
        }

        if(v.getId()==R.id.tab_leftShow){
            ShadowLayout.setShadowHiddenTop(select(tab_leftShow));
        }


        if(v.getId()==R.id.tab_rightShow){
            ShadowLayout.setShadowHiddenTop(select(tab_rightShow));
        }
